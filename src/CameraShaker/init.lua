...
local CameraShakeInstance = loadstring(game:HttpGet("https://raw.githubusercontent.com/LukeLor/RbxCameraShaker/refs/heads/master/src/CameraShaker/CameraShakeInstance.lua"))()
